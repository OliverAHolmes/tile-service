...
def make_tile(layer_name, x, y, z):
    ...
    out_ds = gdal.Warp(test_mem, open_file, format='PNG', outputBounds=[ tile_bounds[0],tile_bounds[1],tile_bounds[2],tile_bounds[3] ],errorThreshold=0,width=256, height=256, dstSRS="EPSG:4326", resampleAlg="near")
    ...
    # return_image = Image.fromarray(buf_rgb)
